local minimap = (modules.game_minimap and modules.game_minimap.minimapWidget) or (modules.game_minimap and modules.game_minimap.minimap)
if not minimap and modules.game_minimap and modules.game_minimap.minimapWindow then
  minimap = modules.game_minimap.minimapWindow:recursiveGetChildById('minimap')
end
