...
local drawGraph = function(graph, value)
    if graph.getGraphsCount and graph:getGraphsCount() == 0 then
        if graph.createGraph then graph:createGraph() end
        if graph.setLineWidth then graph:setLineWidth(1, 1) end
        if graph.setLineColor then graph:setLineColor(1, "#FF0000") end
    end
    if graph.getGraphsCount and graph:getGraphsCount() > 0 then
